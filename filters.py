...
class AttributeFilter:
    ...
    It is constructed with a comparator operator and
    a reference value, and
    calling the filter (with __call__) executes `get(approach) OP value` (in
    infix notation).

    Concrete subclasses can override the `get` classmethod
    to provide custom
    behavior to fetch a desired attribute from the given `CloseApproach`.
    """

    def __init__(self, op, value):
        """Construct a new `AttributeFilter` from predicate and a reference value.

        The reference value will be supplied as the
    ...
    def __repr__(self):
        """Repr method to compare filter attribute."""
...
class DateFilter(AttributeFilter):
    ...
    @classmethod
    def get(cls, approach):
        """Return date of the CloseApproach objectfor the distance filter.
        
        Args:
            approach (CloseApproach): A CloseApproach object.
        Returns:
            [date]: Returns the date of a CloseApproach.
        """
...
class DiameterFilter(AttributeFilter):
    ...
    @classmethod
    def get(cls, approach):
        """Return date of the CloseApproach object for the diameter filter.
        
        Args:
            approach (CloseApproach): A CloseApproach object.
        Returns:
            [float]: Returns the diameter of a CloseApproach.
        """
...
class VelocityFilter(AttributeFilter):
    ...
    @classmethod
    def get(cls, approach):
        """Return date of the CloseApproach object for the velocity filter.
...
class HazardousFilter(AttributeFilter):
    ...
    @classmethod
    def get(cls, approach):
        """Return date of the CloseApproach object for the hazrdous filter.
        
        Args:
            approach (CloseApproach): A CloseApproach object.
        Returns:
            [boolean]: Returns the hazrdous status of a CloseApproach.
        """
...
def create_filters(
    ...
    to a different type
    of filter. For example, the `--date` option corresponds to
    the `date`
    argument, and represents a filter that selects
    close approaches that occurred
    on exactly that given date. Similarly, the `--min-distance`
    option
    corresponds to the `distance_min` argument, and represents
    a filter that
